...
const popularLocations = [
  ...
  { city: "Tokyo", count: "1.8k Properties", image: "https://images.unsplash.com/photo-1540959733332-e94e7bf0bd40?auto=format&fit=crop&q=80&w=400" },
];
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1600607687940-4e52485e5d1c?auto=format&fit=crop&q=80&w=800"
